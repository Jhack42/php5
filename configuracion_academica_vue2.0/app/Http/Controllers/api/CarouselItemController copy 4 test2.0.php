...
class CarouselItemController extends Controller
{
    ...
    public function testNuevo()
    {
        try {
            ...
            $verification = CarouselItem::find($item->id);
            ...
            return response()->json([
                ...
                'data' => $item,
                'date_verification' => [
                    'start_date_sent' => $testData['start_date'],
                    'start_date_saved' => $verification->start_date,
                    'end_date_sent' => $testData['end_date'],
                    'end_date_saved' => $verification->end_date,
                ]
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
