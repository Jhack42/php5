<template>
    <div class="container">
        ...
        <div class="toolbar">
            <div class="top-row">
                <select v-model="newSubCategory.categoryId" :disabled="isSubmitting">
                    ...
                    <option v-for="category in categories" :key="category.n_id_categoria"
        ...
        <div v-if="viewMode === 'pagination'">
            <div v-for="subCategory in paginatedSubCategories" :key="subCategory.n_id_sub_categoria"
                ...
                <button @click="deleteSubCategory(subCategory.n_id_sub_categoria)" class="delete"
        ...
        <div class="subcategories-container" v-else>
            <div v-for="subCategory in filteredSubCategories" :key="subCategory.n_id_sub_categoria"
                ...
                <button @click="deleteSubCategory(subCategory.n_id_sub_categoria)"
                    :disabled="isDeleting">Eliminar</button>
            </div>
        </div>
