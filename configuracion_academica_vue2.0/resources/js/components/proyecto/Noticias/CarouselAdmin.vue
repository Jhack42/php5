            ...
            <div v-if="showPreview" class="ca-preview">
                ...
                <div class="ca-preview__content">
                    <div v-if="previewMode === 'render'" class="ca-preview__render">
                        <div class="ca-preview__content-wrapper">
                            <div v-html="sanitizedContent" class="ca-preview__html-content"></div>
                        </div>
                    </div>
...
import Apps from '../Eventos/Apps.vue';
...
export default {
    ...
    setup() {
        ...
        const sanitizedContent = computed(() => {
            if (!selectedItem.value?.html_content) return '';
            return selectedItem.value.html_content;
        });
