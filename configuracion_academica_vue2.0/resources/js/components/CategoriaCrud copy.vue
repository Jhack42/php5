    ...
    <div class="container">
            ...
            <div class="third-row">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a @click.prevent="setViewMode('scroll')">Barra de desplazamiento</a>
                        <a @click.prevent="setViewMode('pagination')">Paginación</a>
                    </div>
                </div>
        ...
        <div v-else class="scroll-container">
            <table>
                <thead>
                    <tr>
                        <th @click="sortBy('n_idcategoria')">ID <span :class="getSortClass('n_idcategoria')"></span>
                        </th>
    ...
    methods: {
        async fetchCategories() {
            try {
                ...
                if (response.data && Array.isArray(response.data.categorias)) {
                    ...
                    this.categories = [];
                    alert("Error al cargar categorías: estructura de respuesta inesperada.");
                }

                // Al cambiar la vista, aplica los filtros correspondientes
                this.applySearch();
            } catch (error) {
        ...
        setViewMode(mode) {
            if (this.viewMode !== mode) {
                ...
                // Restablecer la lógica de búsqueda y paginación al cambiar de vista
                if (mode === "scroll") {
                    this.filteredCategories = [...this.categories];
        ...
        paginate() {
            ...
            this.changePage(1); // Reinicia en la primera página al cambiar el modo
        },
