...
import Vista2 from '../Components/proyecto/Correos/Vista2.vue';
import omesa from '../Components/proyecto/omesa/TestCrud.vue';
import omesa_test from '../Components/proyecto/omesa/test/test.vue';
