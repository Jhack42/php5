...
<head>
  ...
  <title>404 Low Poly Effect</title>

  <!-- Cargar CSS utilizando la variable $baseUrl -->
...
<body>
  ...
  <!-- Cargar JavaScript utilizando la variable $baseUrl -->
  <script src="<?php echo $baseUrl; ?>scripts.js"></script>
